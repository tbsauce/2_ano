...
public class POO2122 {
	...
	private static void alinea1(PrintStream out) {
		...
		AgenciaTuristica at1 = new AgenciaTuristica("BoraLá", "Aveiro");

		PacoteTuristico p1 = at1.pacoteTuristico("Calmaria", 5, 320);
		p1.adicionaServico(new Voo("TAP1477", LocalDate.parse("2022-07-30"), Classe.TURISTICA));
		p1.adicionaServico(new Alojamento("B&B", 3, 5, Regime.PEQUENOALMOCO));
		System.out.println("Adicionado: " + p1);

		PacoteTuristico p2 = at1.pacoteTuristico("Relaxar", 7, 700);
		...
		PacoteTuristico p3 = at1.pacoteTuristico("Férias mexidas", 8, 380);
		p3.adicionaServico(new Voo("TAP932", LocalDate.parse("2022-08-10"), Classe.TURISTICA));
	...
	// 		for (PacoteTuristico p: at2.pacotesPorPreco(500))	// devolve todos os pacotes turísticos da agencia com preço pessoa/noite inferior ao indicado, 
